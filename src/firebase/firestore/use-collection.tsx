...
export function useCollection<T = any>(
  ...
  useEffect(() => {
    // If there's no query, we are done loading and have no data/error.
    ...
    const unsubscribe = onSnapshot(
      ...
      (error: FirestoreError) => {
        ...
        const path = 'path' in memoizedTargetRefOrQuery ? memoizedTargetRefOrQuery.path : (memoizedTargetRefOrQuery as Query)._query.path.canonicalString();
